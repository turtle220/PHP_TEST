...
<body>
  <div style="text-align: -webkit-right; background-color: #f5f5f5">
    <ul style="width: 70%">
      <li><a class="active" href="#home">Aerial Work Platforms</a></li>
      <li><a href="#news">Air Compressors & Air Tools</a></li>
      <li><a href="#contact">Concrete Masonry</a></li>
      <li><a href="#about">Earthmoving Equipment</a></li>
    </ul>
  </div>
  <div style="width:100%">
